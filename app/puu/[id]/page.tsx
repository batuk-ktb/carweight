...
console.log('allinfo data', data?.allInfo)
  return (
    <div >
        ...
        <div className="flex">
          ...
          <main className="flex-1 p-4 lg:p-6 overflow-x-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <CameraView title="Чингэлэг - 1 баруун" cameraId={`cam${id}1`}/>
              <CameraView title="Чингэлэг - 1 зүүн" cameraId={`cam${id}2`} />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <CameraView title="Чингэлэг - 2 баруун" cameraId={`cam${id}3`} />
              <CameraView title="Чингэлэг - 2 зүүн"cameraId={`cam${id}4`} />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <CameraView title="Чингэлэг - 3 баруун" cameraId={`cam${id}5`} />
              <CameraView title="Чингэлэг - 3 зүүн" cameraId={`cam${id}6`} />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <CameraView title="Чингэлэг - 4 баруун" cameraId={`cam${id}7`} />
              <CameraView title="Чингэлэг - 4 зүүн" cameraId={`cam${id}8`} />
            </div>
            {/* Transaction Table */}
            <TransactionTable
